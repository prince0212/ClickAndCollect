            ...
            search : function(map, coords, latLng, config) {                        
                ...
                for (i = 0; i < markers.length; i++) { 
                    ...
                    if (distance < config.radius) {
                        ...
                        var contentToAppend = "<div class='results-content geo-location-result' data-miles='"+store_distance+"' data-marker='"+markers[i].record_id+"'><p class='results-title'>"+markers[i].global_name+"</p>";
