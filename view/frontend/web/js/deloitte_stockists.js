define([
    ...
    function($,config,country_list,mapstyles,search_widget,currentLocation, base_url) {
        return function (config) {
            $(document).ready(function() {
                $.getScript("https://maps.googleapis.com/maps/api/js?v=3&sensor=false&key="+config.apiKey+"&libraries=places,geometry", function () {
                    getStores();
                ...
                function getStores() {
                    var url = base_url.build('storelocator/ajax/stores');
                ...
                function initialize(response) {
                    ...
                    if(navigator.geolocation){
                        $(document).on("click", ".geocode-location", function(){
                            ...
                            setTimeout(function () {
                                $('.results-content.geo-location-result').show();
                            }, 1000);
                        })       
                    }
